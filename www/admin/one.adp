...
@survey_info.description@</td>
	...
	<tr class="z_dark"><td>View Responses: </td><td >
	<a
	...
	<tr class="z_light"><td valign="top" rowspan="2"><nobr>Response Options: </nobr></td><td> @survey_info.single_response_display@ - [ 
...
<tr class="z_light"><td valign="top" rowspan="2">Email Options:</td><td >@notification_chunk@</td></tr>
	...
	<tr class="z_light"><td ><a href="send-mail?survey_id=@survey_id@">Send bulk
